...
<?php
	...
	?>
		...
		<?php
			...
			printf( '<li class="button-primary pink"><a href="%1$s" target="_blank"><i class="prdctfltr-check"></i> %2$s</a></li>', 'http://codecanyon.net/user/dzeriho/portfolio?ref=dzeriho', esc_html__( 'More plugins for WooCommerce?', 'prdctfltr' ) );
			printf( '<li class="button-primary pink"><a href="%1$s" target="_blank"><i class="prdctfltr-check"></i> %2$s</a></li>', 'http://themeforest.net/user/dzeriho/portfolio?ref=dzeriho', esc_html__( 'Get ShopKit Theme for WooCommerce!', 'prdctfltr' ) );
			if ( isset( $_GET['section'] ) && $_GET['section'] == 'advanced' ) {
				printf( '<li class="button-primary red"><a href="%1$s" id="pf_reset_options" target="_blank"><i class="prdctfltr-delete"></i> %2$s</a></li>', '#', esc_html__( 'Reset Options!', 'prdctfltr' ) );
			}
		?>
		</ul>
		<br class="clear" />
			...
			<?php
				...
				$settings = array(
					...
					'prdctfltr_style_preset' => array(
						...
						'options' => array(
							'pf_arrow' => esc_html__( 'Arrow', 'prdctfltr' ),
							'pf_arrow_inline' => esc_html__( 'Arrow Inline', 'prdctfltr' ),
							'pf_default' => esc_html__( 'Default', 'prdctfltr' ),
							'pf_default_inline' => esc_html__( 'Default Inline', 'prdctfltr' ),
							'pf_select' => esc_html__( 'Use Select Box', 'prdctfltr' ),
							...
							'pf_fullscreen' => esc_html__( 'Full Screen', 'prdctfltr' ),
						),
						'default' => 'pf_default',
						'css' => 'width:300px;margin-right:12px;'
					),
			...
			<div class="prdctfltr_quickview_terms" data-key="<?php echo $key; ?>">
				...
				<div class="prdctfltr_quickview_terms_inner">
					<div class="prdctfltr_quickview_filters_settings">
						...
						<a href="#" class="button prdctfltr_set_filters_add"><?php esc_html_e( 'Add Filter', 'prdctfltr' ); ?></a>
					</div>
