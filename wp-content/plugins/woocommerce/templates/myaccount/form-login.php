...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login login-popup " method="post">
			...
			<?php do_action( 'woocommerce_login_form_start' ); ?>
                    ...
                    <div class="forgot-passwd">
                        <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="">
                            <i class="icon icon-key"></i>
                            <span>Forgot your password?</span>
                        </a>
                       
                    </div>
                    <div class="form-group"> <label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline">
			...
			<?php do_action( 'woocommerce_login_form' ); ?>
				...
				<?php wp_nonce_field( 'woocommerce-login', 'woocommerce-login-nonce' ); ?>
				  		<input type="submit" class="woocommerce-Button btn btn-lg btn-primary btn-block" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
                    </div><!-- /.form-group -->
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register login-popup ">
			...
			<div class="form-group">
	            <label for="login-account">Email address</label>
